        ...
        <nav class="p-5 bg-white shadow md:flex md:items-center md:justify-between">
            <div class="flex justify-between items-center">
                <span class="text-2xl font-[Poppins] cursor pointer">
                    <img class="h-10 inline" src="https://tse4.mm.bing.net/th?id=OIP.iX8wB2BzqkQvK5barncZaQHaCv&pid=Api&P=0&h=180" alt="laravel logo">
            ...
            <ul class="md:flex mdLitems-center z-[-1] md:z-auto md:static absolute bg-white w-full left-0 
            md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500 ">
                <li class="mx-4 my-6 md:my-0">
                   <a class="text-l hover:text-cyan-500 duration-500" href="{{url('home')}}">HOME</a>
                </li>
                <li class="mx-4  my-6 md:my-0">
                    <a class="text-l hover:text-cyan-500 duration-500" href="{{URL::to('contact')}}">CONTACT US</a></li>
                </li>  
                <li class="mx-4  my-6 md:my-0">
                    <a class="text-l hover:text-cyan-500 duration-500" href="{{url("services")}}">OUR SERVICES</a>
                </li>
            </ul>
        </nav>
       <!-- component -->
